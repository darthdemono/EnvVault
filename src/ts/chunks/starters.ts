/**
 * @file
 * Starter chunk templates — the initial set of config sections created
  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          key: 'add_header Strict-Transport-Security',
        ...
        {
          key: 'gzip_types',
          value: 'text/plain text/css text/javascript application/javascript application/json',
          field_type: 'var',
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        {
          key: 'path',
          value: '~* \\.(jpg|jpeg|png|gif|webp|ico|css|js|svg|woff2)$',
          field_type: 'var',
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'SSLEngine', value: 'on', field_type: 'var' },
        {
          ...
          value: '/etc/letsencrypt/live/example.com/fullchain.pem',
          field_type: 'cert',
        },
        {
          key: 'SSLCertificateKeyFile',
          value: '/etc/letsencrypt/live/example.com/privkey.pem',
          field_type: 'cert',
        },
        {
          key: 'Header',
          value: 'always set Strict-Transport-Security "max-age=31536000"',
          field_type: 'var',
        },
      ],
    },
